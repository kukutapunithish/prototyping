...
async def load_knowledge_base(kb_dir: str = KB_DIR) -> None:
    ...
    kb_path = kb_dir / "documents"
    cache_path = kb_dir / "embeddings" / "embeddings.json"
...
async def search_knowledge_base(query: str, top_k: int = 2) -> str:
    ...
    # Use the Google-specific method and model
